...
import TrackViewCar from "@/components/analytics/TrackViewCar";
...
export default async function CarDetailPage({ params }: PageProps) {
  ...
  return (
    <section className="pt-[calc(36px+68px+24px)] pb-16 max-md:pt-[calc(64px+16px)]">
      ...
      />
      <TrackViewCar car={{ id: car.id, name: car.name, price: car.price, fuel: car.fuel, transmission: car.transmission, year: car.year }} />
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        <div className="grid grid-cols-2 gap-3 max-w-[480px] mt-8 mb-12 max-md:grid-cols-1 max-md:max-w-full">
          <TrackClick track={{ event: "phone", context: "detail", carName: car.name }}>
            <a
          ...
          <TrackClick track={{ event: "whatsapp", context: "detail", carName: car.name }}>
            <a
