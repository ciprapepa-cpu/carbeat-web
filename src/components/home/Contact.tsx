...
const contactItems: ContactItem[] = [
  {
    ...
    label: "Telefon",
    value: <TrackClick track={{ event: "phone", context: "kontakt" }}><a href="tel:+420777027809" className="text-blue hover:underline">+420 777 027 809</a></TrackClick>,
  },
  {
        ...
        <div className="grid grid-cols-[1fr_1fr] gap-12 max-lg:grid-cols-1">
          ...
          <div>
            ...
            <div className="flex gap-3 flex-wrap">
              <TrackClick track={{ event: "whatsapp", context: "kontakt" }}>
                <a
              ...
              <TrackClick track={{ event: "navigate" }}>
                <a
